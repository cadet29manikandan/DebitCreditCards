...
public class CreditCardUtils {
    ...
    static final int CARD_SIDE_FRONT = 1, CARD_SIDE_BACK = 0;

    static final int CARD_CVV_PAGE = 2, CARD_NAME_PAGE = 3;
    ...
    private static String handleCardNumber(String inputCardNumber, String seperator) {
    ...
    static String formatCardNumber(String inputCardNumber) {
        String unformattedText = inputCardNumber.replace(CreditCardUtils.SPACE_SEPERATOR, "");
        CardType cardType = selectCardType(inputCardNumber);
        String format = (cardType == CardType.AMEX_CARD) ? CARD_NUMBER_FORMAT_AMEX : CARD_NUMBER_FORMAT;
        StringBuilder sbFormattedNumber = new StringBuilder();
